...
const Icons = (() => {
    const svgs = {
        ...
        // Triangle — underwater (point = bow)
        uuv: '<svg viewBox="0 0 24 24"><polygon points="12,2 21,20 3,20" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="12" cy="13" r="2" fill="currentColor"/></svg>',
    };
